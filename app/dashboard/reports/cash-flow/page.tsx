...
const TabContent = ({ tabValue, periodId }: { tabValue: string; periodId: number }) => {
  ...
  const { data, isLoading, isError } = useCashFlowAggregateByProject(periodId, selectedProjectCode, !!periodId)
  ...
  return <CashFlowStatement initialData={data as any} {...periodLabels} />
}
