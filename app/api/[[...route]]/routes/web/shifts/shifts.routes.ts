...
// POST /shifts/auto-create
export const autoCreateShifts = createRoute({
  path: "/shifts/auto-create",
  method: "post",
  tags,
  request: {
    body: jsonContentRequired(autoCreateShiftsSchema, "Auto-create shifts data"),
  },
  responses: {
    [HttpStatusCodes.CREATED]: jsonContent(
      bulkShiftResponseSchema,
      "Auto-created shifts successfully"
    ),
    [HttpStatusCodes.BAD_REQUEST]: jsonContent(
      errorSchema,
      "Invalid auto-create data"
    ),
  },
});
...
export type AutoCreateShiftsRoute = typeof autoCreateShifts;